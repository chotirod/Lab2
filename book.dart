void main() {
  ...
  book.add(Book(bookCode: 'B004', bookTitle: 'Naruto', bookType: 'Cartoon', bookPrice: 85));
   book.add(Book(bookCode:'B005', bookTitle: 'Python', bookType: 'Textbook', bookPrice: 79));
   book.add(Book(bookCode:'B006', bookTitle: 'Plants vs Zombies', bookType: 'Cartoonง', bookPrice: 107));
